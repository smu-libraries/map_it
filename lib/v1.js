    ...
    switch (doc.doctype) {
      case 'library':
        doc.links = [
          {
            rel: 'self',
            href: `${protocol}://${host}/${VERSION}/libraries/${doc.code}`
          },
          {
            rel: 'locations',
            href: `${protocol}://${host}/${VERSION}/libraries/${doc.code}/locations`
          }
        ];
        break;
      ...
      case 'location':
        doc.links = [
          {
            rel: 'self',
            href: `${protocol}://${host}/${VERSION}/libraries/${library_code}/locations/${doc.code}`
          },
          {
            rel: 'library',
            href: `${protocol}://${host}/${VERSION}/libraries/${library_code}`
          },
          {
            rel: 'ranges',
            href: `${protocol}://${host}/${VERSION}/libraries/${library_code}/locations/${doc.code}/ranges`
          }
        ];
        break;
      ...
      case 'range':
        doc.links = [
          {
            rel: 'self',
            href: `${protocol}://${host}/${VERSION}/libraries/${library_code}/locations/${location_code}/ranges/${doc.code}`
          },
          {
            rel: 'library',
            href: `${protocol}://${host}/${VERSION}/libraries/${library_code}`
          ...
          {
            rel: 'location',
            href: `${protocol}://${host}/${VERSION}/libraries/${library_code}/locations/${location_code}`
          },
          {
            rel: 'map',
            href: `${protocol}://${host}/${VERSION}/libraries/${library_code}/locations/${location_code}/ranges/${doc.code}?view=map`
          }
        ];
        break;
...
router.get(`/libraries`, router.get_libraries);
...
router.get(`/libraries/:library_code`, router.get_library);
...
router.get(`/libraries/:library_code/locations`, router.get_locations);
...
router.get(`/libraries/:library_code/locations/:location_code`, router.get_location);
...
router.get(`/libraries/:library_code/locations/:location_code/ranges`, router.get_ranges);
...
router.get(`/libraries/:library_code/locations/:location_code/ranges/:range_code`, router.get_range);
...
router.get(`/libraries/:library_code/locations/:location_code/search/:call_number`, router.get_range_by_call_number);
